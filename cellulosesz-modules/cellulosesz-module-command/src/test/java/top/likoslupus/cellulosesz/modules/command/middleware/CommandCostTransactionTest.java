...
final class CommandCostTransactionTest {
    ...
    @Test
    void execute_whenLaterValidationRejects_doesNotReserveCost() {
    ...
    @Test
    void execute_whenAsyncSuccess_commitsAfterTerminalOnce() {
        var costs = new FakeCostService();
    ...
    @Test
    void execute_whenTerminalNotSuccess_refundsExactlyOnce() {
    ...
    @Test
    void execute_whenTerminalThrows_refundsAndReturnsFailed() {
        var logger = new RecordingLogger();
        var costs = new FakeCostService();
        var pipeline = pipeline(logger);
        pipeline.addMiddleware(new CommandCostMiddleware(costs), "cost");
    ...
    @Test
    void execute_whenRefundFails_returnsFailedAndLogs() {
        var logger = new RecordingLogger();
        var costs = new FakeCostService();
